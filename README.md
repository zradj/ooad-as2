...
1. Run the demo:
   ...
   java Main
   ```
Unit tests have been supplied by another student of the course (Emil Mirzazada) according to the last assignment's instructions. The remaining portion of this section was written by this student:
